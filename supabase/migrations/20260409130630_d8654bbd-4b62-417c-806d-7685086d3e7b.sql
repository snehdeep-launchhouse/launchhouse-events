...
AS $$
BEGIN
  IF p_status IS NOT NULL AND p_status NOT IN ('partial', 'abandoned') THEN
...
GRANT EXECUTE ON FUNCTION public.update_abandoned_demo_by_session TO anon;
GRANT EXECUTE ON FUNCTION public.update_abandoned_demo_by_session TO authenticated;